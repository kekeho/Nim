...
書かれています。しかしとても基本的なことに留めているので、Nimについてより詳しく知りたければ`manual
<manual.html>`_も見てみてください。より多くの例や、専門的な内容が盛り込まれています。
...
さらに、 `discard文 <#procedures-discard-statement>`_ を使うことで
*long文字列*でブロックコメントを書くこともできます。
